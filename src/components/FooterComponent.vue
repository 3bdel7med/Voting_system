        ...
        <div class="footer-wrap">
                        ...
                        <div class="col-md-12">
                            <div class="standard_social_links">
                                <div>
                                    ...
                                    <li class="round-btn btn-twitter"><a href="#">
                                    ...
                                    <li class="round-btn btn-whatsapp"><a href="#">
                ...
                <div class="container second_class_bdr">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <p>Your one-stop career platform to find Jobs, Internships, Professional Trainings, and Volunteering Opportunities.</p>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <ul class="footer-links">
                                ...
                                <li><a href="#">Jobs &AMP; Internship Fair 2024</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="container-fluid">
                    <div class="copyright"> Copyright 2024 | All Rights Reserved by 3bdel7medmgazy.</div>
                </div>
